...
TiniTalk uses the following third-party software. Each component remains subject
to its own license. Version-specific links are used where the upstream project
provides them.
...
| `github.com/pion/logging` | 0.2.4 | [source](https://github.com/pion/logging/tree/v0.2.4) | [MIT](https://github.com/pion/logging/blob/v0.2.4/LICENSE) |
| `github.com/pion/randutil` | 0.1.0 | [source](https://github.com/pion/randutil/tree/v0.1.0) | [MIT](https://github.com/pion/randutil/blob/v0.1.0/LICENSE) |
| `github.com/pion/stun/v3` | 3.1.5 | [source](https://github.com/pion/stun/tree/v3.1.5) | [MIT](https://github.com/pion/stun/blob/v3.1.5/LICENSE) |
| `github.com/pion/transport/v4` | 4.0.2 | [source](https://github.com/pion/transport/tree/v4.0.2) | [MIT](https://github.com/pion/transport/blob/v4.0.2/LICENSE) |
...
| `modernc.org/memory` | 1.11.0 | [source](https://pkg.go.dev/modernc.org/memory@v1.11.0) | [license files](https://pkg.go.dev/modernc.org/memory@v1.11.0?tab=licenses) |
| `modernc.org/sqlite` | 1.57.0 | [source](https://pkg.go.dev/modernc.org/sqlite@v1.57.0) | [license files](https://pkg.go.dev/modernc.org/sqlite@v1.57.0?tab=licenses) |
