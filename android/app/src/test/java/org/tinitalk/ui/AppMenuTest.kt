...
class AppMenuTest {
    ...
    fun profileShowsServerDetailsForEveryAccount() {
        ...
        composeRule.onNodeWithText("one.example").assertIsDisplayed()
        composeRule.onNodeWithText("two.example").assertIsDisplayed()
        composeRule.onAllNodesWithText("Алексей").assertCountEquals(0)
