...
Экспериментальный [PWA-клиент](docs/pwa.md) находится в `web/`: несколько
учёток независимых серверов, аудиозвонки и Web Push. Статику можно раздавать
самим TiniTalk или отдельным HTTPS-сайтом. Это первый прототип для испытаний.
